...
! function(t) {
    ...
    if (e(), t(".b-catalog-navigation__select-smallest").change(function() {
        ...
        }, "function" == typeof define && define.amd ? define(["jquery"], b) : "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) ? module.exports = b(require("jquery")) : b(jQuery), t.cookie("KEY_CITY11") || t.getScript("https://api-maps.yandex.ru/2.0-stable/?load=package.standard&lang=ru-RU", function(e, i, s) {
            var n = {
                    latitude: 0,
                    longitude: 0
                },
