	...
	<div class="register__form">
		<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform">
			...
			<div class="input-block register__input-block">
				...
				<input type="text" name="USER_EMAIL" tabindex="1" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" placeholder="pocht" class="input register__input"/>
				<label class="caption-error register__caption-error"></label>
			</div>
			<div class="input-block register__input-block">
				<label class="caption register__caption">Телефон</label>
				<input type="text" name="USER_MOBILE"  tabindex="4" value="<?=$arResult["USER_MOBILE"]?>" placeholder="+7 (___) ___ __ __" class="input register__input"/>
				<label class="caption-error register__caption-error"></label>
			</div>
			<div class="input-block register__input-block">
				<label class="caption register__caption">Имя</label>
				<input type="text" name="USER_NAME"  tabindex="2" value="<?=$arResult["USER_NAME"]?>" placeholder="Введите ваше имя" class="input register__input"/>
				<label class="caption-error register__caption-error"></label>
			</div>
			<div class="input-block register__input-block">
				<label class="caption register__caption">Пароль</label>
				<input type="password" name="USER_PASSWORD" tabindex="5" value="<?=$arResult["USER_PASSWORD"]?>" autocomplete="off" placeholder="Ваш пароль" class="input register__input"/>
				<label class="caption-error register__caption-error"></label>
			</div>
			<div class="input-block register__input-block">
				<label class="caption register__caption">Фамилия</label>
				<input type="text" name="USER_LAST_NAME" tabindex="3" value="<?=$arResult["USER_LAST_NAME"]?>" placeholder="Фамилия" class="input register__input"/>
				<label class="caption-error register__caption-error"></label>
			</div>
			<div class="input-block register__input-block">
				<label class="caption register__caption">Повторите пароль</label>
				<input type="password" name="USER_CONFIRM_PASSWORD" tabindex="6" maxlength="50" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" autocomplete="off" placeholder="Повторите ваш пароль" class="input register__input"/>
				<label class="caption-error register__caption-error"></label>
			</div>
			<input type="submit" name="Register" value="Зарегистрироваться" class="btn register__btn">
