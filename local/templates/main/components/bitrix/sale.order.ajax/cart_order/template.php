...
$basketHelper = new \Olimp\Basket();
$arParams['COURIER_TEXT'] = file_get_contents($_SERVER['DOCUMENT_ROOT'].'/include/courier.regions.html');
$date = new DateTime();
$date->add("-1 day");
$arParams['DATE_UNIX'] = $date->getTimestamp();
...
$this->addExternalJs($templateFolder.'/order_ajax2.js');
//echo "<pre>";
//var_dump($this);
...
$emailKey = array_search('EMAIL', array_column($arResult['ORDER_PROP']['RELATED'], 'CODE'));
$arResult['ORDER_PROP']['RELATED'][$emailKey]['VALUE'] = $USER->GetEmail() ? $USER->GetEmail() : '';
$emailKey = array_search('EMAIL', array_column($arResult['JS_DATA']['ORDER_PROP']['properties'], 'CODE'));
$arResult['JS_DATA']['ORDER_PROP']['properties'][$emailKey]['VALUE'] = $USER->GetEmail() ? $USER->GetEmail() : '';

if (strlen($request->get('ORDER_ID')) > 0)
{
//var_dump(Main\Application::getDocumentRoot().$templateFolder);
...
else
{
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title col-sm-9">
							<span class="bx-soa-section-title-count"></span><span class="title-txt"><?=$arParams['MESS_AUTH_BLOCK_NAME']?></span>
						</h2>
					</div>
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					...
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<span class="bx-soa-section-title-count"></span><span class="title-txt"><?=$arParams['MESS_BASKET_BLOCK_NAME']?>*****</span>
							</h2>
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title col-sm-9">
							<span class="bx-soa-section-title-count"></span><span class="title-txt"><?=$arParams['MESS_REGION_BLOCK_NAME']?></span>
						</h2>
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					...
					<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<span class="bx-soa-section-title-count"><span class="title-txt"></span><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?></span>
							</h2>
							<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
				...
				<? else: ?>
					...
					<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<span class="bx-soa-section-title-count"></span><span class="title-txt"><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?></span>
							</h2>
							<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
					...
					<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
								<span class="bx-soa-section-title-count"></span><span class="title-txt"><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?></span>
							</h2>
							<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
				...
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title col-sm-9">
							<span class="bx-soa-section-title-count"></span><span class="title-txt"><?=$arParams['MESS_BUYER_BLOCK_NAME']?></span>
						</h2>
						<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
					</div>
					<div class="bx-soa-section-content container-fluid"></div>
	...
	$arParams['AVALIABLE_ONLINE_PAYMENT'] = $basketHelper->checkBasketGoods();
	_c($arResult);
	?>
	...
	//$arResult['JS_DATA']['OPTIONS_SORT'] = array_keys($arResult['JS_DATA']['OPTIONS']);
	
	if(isset($arResult['JS_DATA']['ORDER_PROP']['properties'][3]['OPTIONS'])){
	
	$arResult['JS_DATA']['ORDER_PROP']['properties'][3]['OPTIONS_SORT'] = array_keys($arResult['JS_DATA']['ORDER_PROP']['properties'][3]['OPTIONS']);
	}
	//var_dump($arResult['JS_DATA']['ORDER_PROP']['properties'][3]['OPTIONS']);
	?>
	...
	<script>
		...
		BX.Sale.OrderAjaxComponent.init({
			...
			ajaxUrl: '<?=CUtil::JSEscape('/local/components/kontora/sale.order.ajax/ajax.php')?>',
