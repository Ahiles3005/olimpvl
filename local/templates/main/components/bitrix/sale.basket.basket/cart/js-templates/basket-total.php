		...
		<div class="basket-checkout-section">
			<div class="basket-checkout-section-inner">
				...
				<div class="basket-checkout-block basket-checkout-block-btn">
                    ...
                    <button name="onebuy" onclick="oneBuy(this)" class="btn b-btn__default btn-lg b-btn__onebuy">
						<span><?=Loc::getMessage('SBB_ONE_BUY')?></span>
					</button>
					<a class="go-credit" href="/kredit/">Оформить рассрочку</a>
				</div>
			</div>
		</div>
