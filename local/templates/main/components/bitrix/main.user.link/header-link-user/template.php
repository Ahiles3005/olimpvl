...
<?//
//foreach ($arResult["User"] as $key => $value) {
//    echo $key.' = '.$value.'<br>';
//}
//?>
...
<li class="dropdown">
	...
	<a href="/personal-area/" class="userlnk" style="float:left" <?=($arParams["SEO_USER"] == "Y" ? ' rel="nofollow"' : '')?> id="anchor_<?=$anchor_id?>"><span class="glyphicon glyphicon-user" aria-hidden="true" style="font-size:75%; top:0px"></span> <?=$arResult["User"]["NAME_FORMATTED"]?></a>
	<a href="/?logout=yes" class="userlnk logouting" title="Выйти"><span class="glyphicon glyphicon-log-out" aria-hidden="true" style="font-size:75%; top:0px"></span></a>
    <?else:?>

	<a href="/auth/?backurl=<?=$APPLICATION->GetCurPage()?>" class="userlnk"><span class="glyphicon glyphicon-user" aria-hidden="true" style="font-size:75%; top:0px"></span> Вход / Регистрация</a>
    <?endif;?>


<?
//echo print_r($arParams["User"]);
