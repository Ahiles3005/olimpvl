	...
	//			?>
				<form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data">
					...
					<div class="input-block personal-area-read-info__input-block">
						<label for="" class="caption personal-area-read-info__caption">Имя</label>
					...
					<div class="input-block personal-area-read-info__input-block">
						<label for="" class="caption personal-area-read-info__caption">Отчество</label>
					...
					<div class="input-block personal-area-read-info__input-block">
						<label for="" class="caption personal-area-read-info__caption">Фамилия</label>
						<input type="text" name="LAST_NAME" maxlength="50" value="<?=$au["LAST_NAME"]?>" placeholder="Фамилия" class="input personal-area-read-info__input"/>
						<label for="" class="caption-error personal-area-read-info__caption-error"></label>
					</div>
					<div class="input-block personal-area-read-info__input-block">
						<label for="" class="caption personal-area-read-info__caption">Телефон</label>
						<input type="text" name="PERSONAL_MOBILE" maxlength="255" value="<?=$au["PERSONAL_MOBILE"]?>" placeholder="+7 (___) ___ __ __" class="input personal-area-read-info__input"/>
						<label for="" class="caption-error personal-area-read-info__caption-error"></label>
					</div>
					<div class="input-block personal-area-read-info__input-block">
						<label for="" class="caption personal-area-read-info__caption">Эл. почта</label>
						<input type="text" name="EMAIL" maxlength="50" value="<? echo $au["EMAIL"]?>" placeholder="E-mail" class="input personal-area-read-info__input"/>
						<label for="" class="caption-error personal-area-read-info__caption-error"></label>
					</div>
					<div class="input-block personal-area-read-info__input-block">
						<label for="" class="caption personal-area-read-info__caption">Индекс</label>
						<input type="text" name="PERSONAL_ZIP" maxlength="255" value="<?=$au["PERSONAL_ZIP"]?>" placeholder="600000" class="input personal-area-read-info__input"/>
						<label for="" class="caption-error personal-area-read-info__caption-error"></label>
					</div>
					<div class="input-block personal-area-read-info__input-block">
