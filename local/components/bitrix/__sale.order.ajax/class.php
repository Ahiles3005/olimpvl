...
//var_dump($arBasketItem);
//$arBasketItem['DETAIL_PAGE_URL'] = "/itema";//str_replace("#PRODUCT_URL#",$arBasketItem["PRODUCT_ID"],$arBasketItem['DETAIL_PAGE_URL']);


/**
@TODO CHANGE URL IN ORDER.AJAX.CART
